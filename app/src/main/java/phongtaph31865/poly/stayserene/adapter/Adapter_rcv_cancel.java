...
public class Adapter_rcv_cancel extends FirebaseRecyclerAdapter<Booking, Adapter_rcv_cancel.ViewHolder> {
    private Context context;

    public Adapter_rcv_cancel(@NonNull FirebaseRecyclerOptions<Booking> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull Adapter_rcv_cancel.ViewHolder viewHolder, int position, @NonNull Booking booking) {
